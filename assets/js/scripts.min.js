function initPreloader(){document.getElementById("preloader")&&(showPreloader(),window.addEventListener("load",function(){hidePreloader()}),setTimeout(function(){hidePreloader()},5e3),setTimeout(function(){hidePreloader()},1e4))}function showPreloader(){var i=document.getElementById("preloader");if(i){i.classList.remove("hidden","removed"),i.style.display="flex";let e=i.querySelector(".preloader-live-region");e||((e=document.createElement("div")).className="preloader-live-region sr-only",e.setAttribute("aria-live","polite"),e.setAttribute("aria-atomic","true"),i.appendChild(e)),e.textContent="Page is loading, please wait...";i=i.querySelector(".preloader-progress-bar");i&&(i.style.animation="progress 3s ease-in-out infinite")}}function hidePreloader(){let e=document.getElementById("preloader");var i;e&&!e.classList.contains("hidden")&&((i=e.querySelector(".preloader-live-region"))&&(i.textContent="Page has finished loading"),e.classList.add("hidden"),setTimeout(function(){e.classList.add("removed"),e.style.display="none"},500))}function forceHidePreloader(){var e=document.getElementById("preloader");e&&(e.classList.add("hidden","removed"),e.style.display="none")}document.addEventListener("DOMContentLoaded",function(){let s=document.querySelectorAll(".accordion-item");var e=document.querySelectorAll(".accordion-question");s.forEach(e=>{var i,t=e.querySelector(".accordion-answer"),o=e.querySelector(".accordion-question");o&&(o.setAttribute("aria-expanded","false"),o.setAttribute("aria-controls",t?t.id||"accordion-"+Math.random().toString(36).substr(2,9):"")),t&&(i=t.id||o.getAttribute("aria-controls"),!t.id&&i&&(t.id=i),t.setAttribute("aria-hidden","true")),e.classList.contains("active")&&(t.style.maxHeight=t.scrollHeight+"px",o&&o.setAttribute("aria-expanded","true"),t)&&t.setAttribute("aria-hidden","false")}),e.forEach(e=>{function i(e){var i=e.closest(".accordion-item"),t=i.querySelector(".accordion-answer"),o=i.classList.contains("active");s.forEach(e=>{e.classList.remove("active");var i=e.querySelector(".accordion-answer"),e=e.querySelector(".accordion-question");i&&(i.style.maxHeight=null,i.setAttribute("aria-hidden","true")),e&&e.setAttribute("aria-expanded","false")}),o||(i.classList.add("active"),t.style.maxHeight=t.scrollHeight+"px",e.setAttribute("aria-expanded","true"),t.setAttribute("aria-hidden","false"))}e.addEventListener("click",function(){i(this)}),e.addEventListener("keydown",function(e){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),i(this))})})}),document.addEventListener("DOMContentLoaded",()=>{let o=document.getElementById("mobile-menu"),i=document.getElementById("mobile-menu-overlay"),t=document.querySelector(".header-burger");var e=document.querySelector(".mobile-menu__close");let s=document.body;function n(){o.classList.remove("active"),i.classList.remove("active"),t.setAttribute("aria-expanded","false"),t.classList.remove("active"),s.classList.remove("no-scroll"),s.classList.remove("mobile-menu-open"),t&&t.focus()}t&&o&&i&&t.addEventListener("click",()=>{if("true"===t.getAttribute("aria-expanded"))n();else{o.classList.add("active"),i.classList.add("active"),t.setAttribute("aria-expanded","true"),t.classList.add("active"),s.classList.add("no-scroll"),window.innerWidth<768&&s.classList.add("mobile-menu-open");let e=o.querySelector("a, button");e&&setTimeout(()=>{e.focus()},100)}}),i&&i.addEventListener("click",n),e&&e.addEventListener("click",n),document.addEventListener("keydown",e=>{"Escape"===e.key&&o&&o.classList.contains("active")&&n()}),o&&o.addEventListener("keydown",e=>{var i,t;o.classList.contains("active")&&(i=(t=o.querySelectorAll('a, button, input, textarea, select, [tabindex]:not([tabindex="-1"])'))[0],t=t[t.length-1],"Tab"===e.key)&&(e.shiftKey?document.activeElement===i&&(e.preventDefault(),t.focus()):document.activeElement===t&&(e.preventDefault(),i.focus()))})}),(s=>{function t(){var e=s("#preloader");0!==e.length&&(e.removeClass("hidden removed").show(),0<(e=e.find(".preloader-content")).length)&&e.attr("data-text","Loading...")}function o(){let e=s("#preloader");0!==e.length&&(e.addClass("hidden"),setTimeout(function(){e.addClass("removed")},500))}function n(){s("body").append(`
        ...
        `)}function r(e,i){i=s(`
            <div class="error-message" style="
                ...
                font-style: italic;
            ">${i}</div>
        `);e.after(i)}s(document).ready(function(){window.bnxOptions&&window.bnxOptions.preloaderEnabled&&(t(),s(window).on("load",function(){o()}),setTimeout(function(){o()},5e3));var e,i=window.bnxOptions&&window.bnxOptions.maintenanceMode;if(i&&(s("#wpadminbar").length&&(i=s("#wpadminbar"),e=s(`
